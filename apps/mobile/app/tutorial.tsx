...
const makeStyles = (theme: Theme) =>
  StyleSheet.create({
    ...
    skip: { color: theme.textDim, fontSize: 15 },
    dots: {
      flexDirection: 'row',
      gap: spacing.sm,
      paddingHorizontal: spacing.lg,
    ...
    bullet: { color: theme.brand, fontSize: 16 },
    pointText: { flex: 1, color: theme.textMuted, fontSize: 15, lineHeight: 21 },
    whereBox: {
      marginTop: spacing.lg,
    ...
    whereText: { color: theme.textDim, fontSize: 14 },
