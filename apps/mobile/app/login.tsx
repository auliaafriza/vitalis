...
const makeStyles = (theme: Theme) =>
  StyleSheet.create({
    ...
    brand: { color: theme.brand, fontSize: 28, fontWeight: '700' },
    title: { color: theme.text, fontSize: 22, fontWeight: '600', marginTop: spacing.sm },
    subtitle: { color: theme.textDim, fontSize: 14, marginTop: 4 },
    ...
    notice: { color: theme.brand, fontSize: 14 },
    successCard: {
    ...
    successTitle: { color: theme.brand, fontSize: 16, fontWeight: '700' },
    noticeCard: { backgroundColor: theme.surface, borderColor: theme.border },
    noticeTitle: { color: theme.text },
    successBody: { color: theme.textMuted, fontSize: 14, lineHeight: 20 },
    successStrong: { color: theme.text, fontWeight: '600' },
    successMeta: { color: theme.textDim, fontSize: 13, lineHeight: 18, marginTop: 2 },
    forgot: {
