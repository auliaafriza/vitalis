      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        */}
        ...
        <Card>
          ...
          <Text style={styles.meta}>
            {summary?.sleepMin
              ? formatDuration(summary.sleepMin)
              : "Belum dicatat"}
          </Text>
          <TextInput
            value={sleepHours}
        ...
        <Card>
          ...
          <Text style={styles.meta}>
            {summary?.steps
              ? summary.steps.toLocaleString("id-ID")
              : "Belum dicatat"}
        ...
        <Card>
          ...
          />
          {bmiValue !== null ? (
            <Text style={[styles.meta, { color: theme.move }]}>
              BMI {bmiValue} · {BMI_LABEL[bmiCategory(bmiValue)]} (ambang WHO
              Asia-Pasifik)
            </Text>
          ) : null}
          <Button
...
const makeStyles = (theme: Theme) =>
  StyleSheet.create({
    ...
    waterTime: { color: theme.textDim, fontSize: 13 },
