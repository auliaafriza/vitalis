...
const makeStyles = (theme: Theme) =>
  StyleSheet.create({
    ...
    screenTitle: { color: theme.text, fontSize: 24, fontWeight: '700' },
    ...
    avatarText: { color: theme.brand, fontSize: 24, fontWeight: '700' },
    ...
    cardHint: { color: theme.textDim, fontSize: 13, marginTop: 4, lineHeight: 18 },
    savedTag: { color: theme.brand, fontSize: 13, fontWeight: '700' },
    fieldError: { color: theme.danger, fontSize: 13, marginTop: 6 },
    ...
    fieldLabel: { color: theme.textMuted, fontSize: 14, flex: 1 },
    fieldInputWrap: {
      flexDirection: 'row',
      alignItems: 'center',
      gap: 6,
    ...
    themeLabel: { color: theme.textDim, fontSize: 12, fontWeight: '600' },
